#Logistic regression on a highly uncorrelated dataset (SMarket dataset)
getwd()
#Step1: reading data
...
#Step2 : calculating correlation among the variables
...
test <- Smarket[!Smarket$Year < 2005,] #20% of total data

#Approach 2: Stratified split
library(caret)
